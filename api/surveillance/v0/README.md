...
go tool oapi-codegen -o surveillance.server.gen.go -package surveillance_dss_v0 -generate server  -include-tags dss ../surveillance.yaml
...
go tool oapi-codegen -o surveillance.types.gen.go -package surveillance_uss_v0 -generate types  -include-tags sp ../surveillance.yaml
go tool oapi-codegen -o surveillance.server.gen.go -package surveillance_uss_v0 -generate server  -include-tags sp ../surveillance.yaml